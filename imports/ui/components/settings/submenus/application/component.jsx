...
class ApplicationMenu extends BaseMenu {
  ...
  handleIncreaseFontSize() {
    ...
    const canIncreaseFontSize =
      availableFontSizes.indexOf(currentFontSize) < maxFontSize;
    const fs = canIncreaseFontSize
      ? availableFontSizes.indexOf(currentFontSize) + 1
      : maxFontSize;
  ...
  handleDecreaseFontSize() {
    ...
    const canDecreaseFontSize =
      availableFontSizes.indexOf(currentFontSize) > MIN_FONTSIZE;
        ...
        <div className={styles.form}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.col}>
              <div
                aria-hidden
                className={cx(styles.formElement, styles.pullContentCenter)}
              >
                ...
                <div className={styles.pullContentRight}>
                  <div className={styles.col}>
                    ...
                    >
                      ...
                      <ReactTooltip id="substract">
                        <span>{`${intl.formatMessage(
                          intlMessages.decreaseFontBtnLabel
                        )}, ${ariaValueLabel}`}</span>
                      </ReactTooltip>
                    </IconButton>
                  </div>
                  <div className={styles.col}>
                    ...
                    >
                      ...
                      <ReactTooltip id="add">
                        <span>{`${intl.formatMessage(
                        intlMessages.increaseFontBtnLabel
                      )}, ${ariaValueLabel}`}</span>
                      </ReactTooltip>
                    </IconButton>
                  </div>
